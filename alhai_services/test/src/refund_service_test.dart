...
class FakeRefundsRepository implements RefundsRepository {
  ...
  @override
  Future<Refund> getRefund(String id) async => throw UnimplementedError();
  @override
  Future<Paginated<Refund>> getStoreRefunds(String storeId,
          {RefundStatus? status,
          String? cashierId,
          DateTime? startDate,
          DateTime? endDate,
  ...
  Future<Refund> rejectRefund(
          String refundId, String supervisorId, String reason) async =>
      throw UnimplementedError();
  @override
  Future<Refund> completeRefund(String refundId) async =>
      throw UnimplementedError();
  @override
  Future<RefundsSummary> getStoreSummary(String storeId,
...
void main() {
  ...
  setUp(() {
    refundService = RefundService(FakeRefundsRepository());
  });

  group('RefundService', () {
    test('should be created', () {
      expect(refundService, isNotNull);
    });

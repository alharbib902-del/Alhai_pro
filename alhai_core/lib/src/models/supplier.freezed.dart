...
class _$SupplierImpl extends _Supplier {
  ...
  @override
  String toString() {
    return 'Supplier(id: $id, storeId: $storeId, name: $name, phone: $phone, email: $email, address: $address, notes: $notes, balance: $balance, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }

...
mixin _$UpdateProductParams {
  ...
  /// Serializes this UpdateProductParams to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateProductParams
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateProductParamsCopyWith<UpdateProductParams> get copyWith =>
...
/// @nodoc
class _$UpdateProductParamsCopyWithImpl<$Res, $Val extends UpdateProductParams>
    implements $UpdateProductParamsCopyWith<$Res> {
  _$UpdateProductParamsCopyWithImpl(this._value, this._then);
...
class _$UpdateProductParamsImpl implements _UpdateProductParams {
  ...
  @override
  String toString() {
    return 'UpdateProductParams(id: $id, name: $name, price: $price, description: $description, imageUrl: $imageUrl, barcode: $barcode, categoryId: $categoryId, available: $available)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductParamsImpl &&

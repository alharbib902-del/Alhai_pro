  ...
  group('AlhaiPriceText', () {
    testWidgets('renders price with currency', (tester) async {
      await tester.pumpWidget(
        createTestWidget(const AlhaiPriceText(amount: 25.50, currency: 'SAR')),
      );
    ...
    testWidgets('renders whole number without decimals', (tester) async {
      await tester.pumpWidget(
        createTestWidget(const AlhaiPriceText(amount: 100, currency: 'SAR')),
      );
    ...
    testWidgets('renders with decimal', (tester) async {
      await tester.pumpWidget(
        createTestWidget(const AlhaiPriceText(amount: 99.99, currency: 'SAR')),
      );

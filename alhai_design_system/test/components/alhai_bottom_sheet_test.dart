  ...
  group('AlhaiBottomSheet', () {
    testWidgets('renders child content', (tester) async {
      await tester.pumpWidget(
        createTestWidget(const AlhaiBottomSheet(child: Text('Sheet Content'))),
      );
    ...
    testWidgets('shows title when provided', (tester) async {
      await tester.pumpWidget(
        createTestWidget(
          const AlhaiBottomSheet(title: 'Sheet Title', child: Text('Content')),
        ),
      );
    ...
    testWidgets('shows close button by default', (tester) async {
      await tester.pumpWidget(
        createTestWidget(
          const AlhaiBottomSheet(title: 'Title', child: Text('Content')),
        ),
      );

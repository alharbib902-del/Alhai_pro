...
void main() {
  group('AlhaiAvatar', () {
    testWidgets('renders with default icon fallback', (tester) async {
      await tester.pumpWidget(createTestWidget(const AlhaiAvatar()));
    ...
    testWidgets('renders with initials', (tester) async {
      await tester.pumpWidget(
        createTestWidget(AlhaiAvatar.initials(initials: 'AB')),
      );
    ...
    testWidgets('truncates initials to 2 characters', (tester) async {
      await tester.pumpWidget(
        createTestWidget(AlhaiAvatar.initials(initials: 'ABC')),
      );
    ...
    testWidgets('renders with custom icon', (tester) async {
      await tester.pumpWidget(
        createTestWidget(AlhaiAvatar.icon(icon: Icons.star)),
      );
    ...
    testWidgets('shows online dot when showOnlineDot is true', (tester) async {
      await tester.pumpWidget(
        createTestWidget(const AlhaiAvatar(showOnlineDot: true)),
      );
    ...
    testWidgets('shows badge when provided', (tester) async {
      await tester.pumpWidget(
        createTestWidget(const AlhaiAvatar(badge: AlhaiBadge(count: 3))),
      );
    ...
    group('sizes', () {
      testWidgets('xs size renders with correct diameter', (tester) async {
        await tester.pumpWidget(
          createTestWidget(const AlhaiAvatar(size: AlhaiAvatarSize.xs)),
        );
      ...
      testWidgets('xl size renders with correct diameter', (tester) async {
        await tester.pumpWidget(
          createTestWidget(const AlhaiAvatar(size: AlhaiAvatarSize.xl)),
        );
    ...
    group('shapes', () {
      testWidgets('circle shape renders', (tester) async {
        await tester.pumpWidget(
          createTestWidget(const AlhaiAvatar(shape: AlhaiAvatarShape.circle)),
        );
      ...
      testWidgets('rounded shape renders', (tester) async {
        await tester.pumpWidget(
          createTestWidget(const AlhaiAvatar(shape: AlhaiAvatarShape.rounded)),
        );
    ...
    group('all sizes', () {
      testWidgets('renders small size', (tester) async {
        await tester.pumpWidget(
          createTestWidget(
            AlhaiAvatar.initials(initials: 'SM', size: AlhaiAvatarSize.sm),
          ),
        );
      ...
      testWidgets('renders medium size', (tester) async {
        await tester.pumpWidget(
          createTestWidget(
            AlhaiAvatar.initials(initials: 'MD', size: AlhaiAvatarSize.md),
          ),
        );
      ...
      testWidgets('renders large size', (tester) async {
        await tester.pumpWidget(
          createTestWidget(
            AlhaiAvatar.initials(initials: 'LG', size: AlhaiAvatarSize.lg),
          ),
        );

  ...
  group('AlhaiEmptyState', () {
    testWidgets('renders icon and title', (tester) async {
      await tester.pumpWidget(
        createTestWidget(
          const AlhaiEmptyState(icon: Icons.inbox, title: 'No items'),
        ),
      );
    ...
    group('factories', () {
      testWidgets('noData factory renders', (tester) async {
        await tester.pumpWidget(
          createTestWidget(AlhaiEmptyState.noData(title: 'No data')),
        );
      ...
      testWidgets('noResults factory renders', (tester) async {
        await tester.pumpWidget(
          createTestWidget(AlhaiEmptyState.noResults(title: 'No results')),
        );
      ...
      testWidgets('noOrders factory renders', (tester) async {
        await tester.pumpWidget(
          createTestWidget(AlhaiEmptyState.noOrders(title: 'No orders')),
        );
      ...
      testWidgets('noProducts factory renders', (tester) async {
        await tester.pumpWidget(
          createTestWidget(AlhaiEmptyState.noProducts(title: 'No products')),
        );
      ...
      testWidgets('error factory renders', (tester) async {
        await tester.pumpWidget(
          createTestWidget(AlhaiEmptyState.error(title: 'Error occurred')),
        );

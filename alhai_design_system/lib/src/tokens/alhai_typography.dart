...
abstract final class AlhaiTypography {
  ...
  static TextStyle get displayMedium =>
      _tajawal(fontSize: 45, fontWeight: FontWeight.w400, height: 1.16);

  static TextStyle get displaySmall =>
      _tajawal(fontSize: 36, fontWeight: FontWeight.w400, height: 1.22);
  ...
  static TextStyle get headlineLarge =>
      _tajawal(fontSize: 32, fontWeight: FontWeight.w500, height: 1.25);

  static TextStyle get headlineMedium =>
      _tajawal(fontSize: 28, fontWeight: FontWeight.w500, height: 1.29);

  static TextStyle get headlineSmall =>
      _tajawal(fontSize: 24, fontWeight: FontWeight.w500, height: 1.33);
  ...
  static TextStyle get titleLarge =>
      _tajawal(fontSize: 22, fontWeight: FontWeight.w500, height: 1.27);

...
## Phase 10: الفاتورة الرقمية وتحميل التطبيق ★ جديد
| الشاشة | المسار | الأولوية |
|--------|--------|----------|
| إعدادات الفاتورة الرقمية | `/settings/digital-receipt` | P1 |
| تقرير تحميلات التطبيق | `/reports/app-downloads` | P2 |
| إعدادات برنامج الإحالة | `/settings/referral` | P1 |
...
│ purchasePrice                                               │
│ minStock                                                    │
│ imageUrl? (deprecated - استخدم الحقول التالية)              │
│ imageThumbnail? (300x300 - للقوائم) R2 CDN                 │
│ imageMedium? (600x600 - للتفاصيل) R2 CDN                   │
│ imageLarge? (1200x1200 - للتكبير) R2 CDN                   │
│ imageHash? (للـ versioning)                                 │
│ isActive                                                    │
│ createdAt, updatedAt                                        │
└─────────────────────────────────────────────────────────────┘

...
import 'package:alhai_core/alhai_core.dart' hide getIt, configureDependencies;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    '${product.costPrice?.toStringAsFixed(2) ?? '0.00'} ${l10n.sar}',
        ...
        child: DataTable(
          ...
          rows: sampleData.map((item) {
            return DataRow(cells: [
              ...
              DataCell(Text(
                '${item.oldPrice.toStringAsFixed(2)} ${l10n.sar}',
                style: TextStyle(
                  color: AppColors.getTextMuted(isDark),
              ...
              DataCell(Text(
                '${item.newPrice.toStringAsFixed(2)} ${l10n.sar}',
                style: const TextStyle(fontWeight: FontWeight.w600),
              )),

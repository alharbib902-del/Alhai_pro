  ...
  Widget _buildSummaryRow(TeamPerformanceSummary summary, bool isDark, bool isWideScreen) {
    ...
    return Wrap(
      ...
      children: items.map((item) {
        return SizedBox(
          width: isWideScreen ? (MediaQuery.of(context).size.width - 340) / 5 - 12 : (MediaQuery.of(context).size.width - 60) / 2 - 6,
          child: Container(
        ...
        return SingleChildScrollView(
          ...
          child: Wrap(
            ...
            children: staff.asMap().entries.map((entry) {
              return SizedBox(
                width: isWideScreen ? (MediaQuery.of(context).size.width - 340) / 2 - 28 : double.infinity,

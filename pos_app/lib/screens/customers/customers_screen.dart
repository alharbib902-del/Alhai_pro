...
class _CustomersScreenState extends ConsumerState<CustomersScreen> {
        ...
        children: [
          ...
          Expanded(
            child: _StatCard(
              ...
              value: '${_totalCredit.toStringAsFixed(0)} ${l10n.currency}',
  ...
  Widget _buildCustomersContent(bool isDark, AppLocalizations l10n) {
    if (_isLoading) {
      return Center(child: AppLoadingState(message: l10n.loadingCustomers));
    }
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            l10n.dueAmountLabel(account.balance.abs().toStringAsFixed(2)),
              ...
              Wrap(
                ...
                children: [50, 100, 200, 500].map((amount) {
                  ...
                  ..add(ActionChip(
                    ...
                    onPressed: () => controller.text = account.balance.abs().toStringAsFixed(0),
                ...
                SnackBar(
                  content: Row(
                    children: [
                      const Icon(Icons.check_circle_rounded, color: Colors.white),
                      const SizedBox(width: AppSizes.sm),
                      Text(l10n.paymentRecorded(amount.toStringAsFixed(0))),
                    ],
                  ),
                  backgroundColor: AppColors.success,
                  behavior: SnackBarBehavior.floating,
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      '${widget.customer.balance.abs().toStringAsFixed(0)} ${widget.l10n.currency}',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                        color: hasDebt

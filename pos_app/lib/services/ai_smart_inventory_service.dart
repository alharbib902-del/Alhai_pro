...
class AiSmartInventoryService {
  ...
  Future<List<AbcItem>> getAbcAnalysis(String storeId) async {
    final _ = _db.productsDao;
    return const [
      AbcItem(productId: 'P001', name: 'أرز بسمتي', category: AbcCategory.a,
        revenue: 40320.0, percentage: 22.5, cumulativePercentage: 22.5, unitsSold: 1440, price: 28.0),
      AbcItem(productId: 'P009', name: 'دجاج طازج', category: AbcCategory.a,
        revenue: 36750.0, percentage: 20.5, cumulativePercentage: 43.0, unitsSold: 1050, price: 35.0),
      AbcItem(productId: 'P005', name: 'حفاضات بامبرز', category: AbcCategory.a,
        revenue: 28800.0, percentage: 16.1, cumulativePercentage: 59.1, unitsSold: 640, price: 45.0),
      AbcItem(productId: 'P017', name: 'زيت عافية', category: AbcCategory.b,
        revenue: 15840.0, percentage: 8.8, cumulativePercentage: 67.9, unitsSold: 720, price: 22.0),
      AbcItem(productId: 'P019', name: 'تمر سكري', category: AbcCategory.b,
        revenue: 13000.0, percentage: 7.3, cumulativePercentage: 75.2, unitsSold: 520, price: 25.0),
      AbcItem(productId: 'P011', name: 'شاي ربيع', category: AbcCategory.b,
        revenue: 10800.0, percentage: 6.0, cumulativePercentage: 81.2, unitsSold: 720, price: 15.0),
      AbcItem(productId: 'P007', name: 'حليب طويل الأمد', category: AbcCategory.b,
        revenue: 8400.0, percentage: 4.7, cumulativePercentage: 85.9, unitsSold: 1200, price: 7.0),
      AbcItem(productId: 'P004', name: 'جبنة بيضاء', category: AbcCategory.c,
        revenue: 6240.0, percentage: 3.5, cumulativePercentage: 89.4, unitsSold: 520, price: 12.0),
      AbcItem(productId: 'P018', name: 'لبن المراعي', category: AbcCategory.c,
        revenue: 5070.0, percentage: 2.8, cumulativePercentage: 92.2, unitsSold: 780, price: 6.5),
      AbcItem(productId: 'P012', name: 'سكر أبيض', category: AbcCategory.c,
        revenue: 3840.0, percentage: 2.1, cumulativePercentage: 94.3, unitsSold: 480, price: 8.0),
      AbcItem(productId: 'P003', name: 'خبز عربي', category: AbcCategory.c,
        revenue: 3780.0, percentage: 2.1, cumulativePercentage: 96.4, unitsSold: 1080, price: 3.5),
      AbcItem(productId: 'P010', name: 'صلصة طماطم', category: AbcCategory.c,
        revenue: 3510.0, percentage: 2.0, cumulativePercentage: 98.4, unitsSold: 780, price: 4.5),
    ];
  }
  ...
  Future<List<WastePrediction>> getWastePredictions(String storeId) async {
    ...
    return [
      WastePrediction(
        ...
        daysToExpiry: 3, sellRate: 12.0, predictedWaste: 58.8, predictedWasteUnits: 49,
      ...
      WastePrediction(
        ...
        daysToExpiry: 1, sellRate: 45.0, predictedWaste: 62.5, predictedWasteUnits: 75,
      ...
      WastePrediction(
        ...
        daysToExpiry: 2, sellRate: 8.0, predictedWaste: 54.3, predictedWasteUnits: 19,
      ...
      WastePrediction(
        ...
        daysToExpiry: 7, sellRate: 4.0, predictedWaste: 30.0, predictedWasteUnits: 12,
      ...
      WastePrediction(
        ...
        daysToExpiry: 30, sellRate: 6.5, predictedWaste: 2.5, predictedWasteUnits: 5,
  ...
  Future<List<ReorderSuggestion>> getReorderSuggestions(String storeId) async {
    ...
    return const [
      ReorderSuggestion(
        ...
        urgency: UrgencyLevel.critical, supplier: 'شركة الراجحي للتوزيع', // Al-Rajhi Distribution
        estimatedCost: 3360.0, daysOfStock: 2,
      ),
      ReorderSuggestion(
        productId: 'P005', name: 'حفاضات بامبرز', // Pampers Diapers
        currentStock: 18, reorderPoint: 30, suggestedQty: 80,
        urgency: UrgencyLevel.high, supplier: 'المستودعات المتحدة', // United Warehouses
        estimatedCost: 3600.0, daysOfStock: 5,
      ),
      ReorderSuggestion(
        productId: 'P017', name: 'زيت عافية', // Afia Oil
        currentStock: 22, reorderPoint: 25, suggestedQty: 60,
        urgency: UrgencyLevel.medium, supplier: 'صافولا للتوزيع', // Savola Distribution
      ...
      ReorderSuggestion(
        ...
        urgency: UrgencyLevel.low, supplier: 'شركة الغذاء المتكامل', // Integrated Food Co

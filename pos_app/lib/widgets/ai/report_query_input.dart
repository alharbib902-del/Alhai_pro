...
class _ReportQueryInputState extends State<ReportQueryInput> {
  ...
  void initState() {
    ...
    _focusNode.addListener(() {
      setState(() => _showSuggestions = _focusNode.hasFocus && _filteredSuggestions.isNotEmpty);
    });
  }
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 13,
                      color: widget.isDark ? Colors.white.withValues(alpha: 0.8) : AppColors.textPrimary,
                    ),
                  ),
                ),
                Container(

      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(l10n.revenueAnalysis, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: isDark ? Colors.white : AppColors.textPrimary)),
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(l10n.last7Days, style: TextStyle(fontSize: 13, color: isDark ? Colors.white : AppColors.textPrimary)),

...
///
/// Usage:
/// flutter run --dart-define=SENTRY_DSN_DISTRIBUTOR=https://xxx@xxx.ingest.sentry.io/xxx
/// flutter build web --dart-define=SENTRY_DSN_DISTRIBUTOR=https://xxx@xxx.ingest.sentry.io/xxx
const _sentryDsn = String.fromEnvironment('SENTRY_DSN_DISTRIBUTOR');

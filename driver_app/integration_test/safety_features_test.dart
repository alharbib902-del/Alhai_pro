...
void main() {
  ...
  group('Safety Features - ميزات السلامة', () {
    ...
    group('SOS Emergency Button', () {
      testWidgets('SOS button is accessible from home screen', (tester) async {
        ...
        await tester.pumpWidget(
          ProviderScope(
            child: MaterialApp(
              ...
              home: Scaffold(
                body: const Center(child: Text('Home', key: Key('stub_Home'))),
    ...
    group('Wake Lock During Active Delivery', () {
      ...
      testWidgets('leaving navigation screen implies wake lock is released', (
        tester,
      ) async {
        ...
        expect(find.byKey(Key('stub_Navigate $kTestDeliveryId')), findsNothing);
        expectStubScreen('Proof $kTestDeliveryId');
      });

      testWidgets('home screen does not imply wake lock (no active delivery)', (
        tester,
      ) async {
    ...
    group('Mock GPS Detection', () {
      testWidgets('status transition requires valid location context', (
        tester,
      ) async {
    ...
    group('Shift Toggle Guard', () {
      ...
      testWidgets('cannot end shift while active delivery exists', (
        tester,
      ) async {
        ...
        expect(find.byKey(const Key('shift_guard_message')), findsOneWidget);
      });

      testWidgets('can end shift when no active deliveries', (tester) async {

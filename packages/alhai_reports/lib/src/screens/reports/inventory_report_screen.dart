                ...
                child: Row(
                  children: [
                    Icon(Icons.attach_money,
                        color: Theme.of(context).colorScheme.surface, size: 32),
                    const SizedBox(width: AlhaiSpacing.sm),
                    Text(l10n.inventoryReport,
                        style: TextStyle(
                            color: Theme.of(context).colorScheme.surface)),
                    const Spacer(),
                    Text('${totalValue.toStringAsFixed(0)} ${l10n.sar}',
                        style: TextStyle(
                            color: Theme.of(context).colorScheme.surface,
                            fontSize: 24,
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    ...
                    ...inventory.map((i) => i.category).toSet().map((cat) =>
                        _FilterChip(
                            label: cat,
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    rows: filtered.map((item) {
                      ...
                      return DataRow(
                        color: WidgetStateProperty.resolveWith((states) => isLow
                        ...
                        cells: [
                          ...
                          DataCell(Text(
                              (item.cost * item.stock).toStringAsFixed(0))),
                          DataCell(isLow
                              ? Container(

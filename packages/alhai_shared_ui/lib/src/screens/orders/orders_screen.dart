  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ordersAsync.when(
        ...
        data: (ordersData) {
          final allOrders = ordersData
              .map((o) => OrderModel.fromData(o))
              .toList();
          ...
          children: [
            ...
            Expanded(
              ...
              child: Column(
                children: [
                  Text(
                    '${order.amount.toStringAsFixed(2)} ${l10n.currency}',
                    style: TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.bold,
                      color: textColor,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                '${total.toStringAsFixed(2)} ${l10n.currency}',
                style: const TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                  color: AppColors.primary,

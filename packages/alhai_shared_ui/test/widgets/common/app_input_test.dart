...
void main() {
  group('AppTextField', () {
    testWidgets('should display label', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(const AppTextField(label: 'Username')),
      );
    ...
    testWidgets('should display hint text', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(const AppTextField(hint: 'Enter value')),
      );
    ...
    testWidgets('should use provided controller', (tester) async {
      ...
      await tester.pumpWidget(
        createSimpleTestWidget(AppTextField(controller: controller)),
      );
    ...
    testWidgets('should show prefix icon', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(const AppTextField(prefixIcon: Icons.search)),
      );
    ...
    testWidgets('should toggle password visibility', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(const AppTextField(obscureText: true)),
      );
    ...
    testWidgets('should show error text', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(const AppTextField(errorText: 'Invalid input')),
      );
    ...
    testWidgets('should be disabled when enabled is false', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(const AppTextField(enabled: false)),
      );
    ...
    testWidgets('search factory should show search icon', (tester) async {
      await tester.pumpWidget(createSimpleTestWidget(AppTextField.search()));
      expect(find.byIcon(Icons.search), findsOneWidget);
    });

    testWidgets('number factory should render', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(AppTextField.number(label: 'Amount')),
      );
      expect(find.text('Amount'), findsOneWidget);
    });

    testWidgets('phone factory should show phone icon', (tester) async {
      await tester.pumpWidget(createSimpleTestWidget(AppTextField.phone()));
  ...
  group('AppSearchField', () {
    testWidgets('should display search icon', (tester) async {
      await tester.pumpWidget(createSimpleTestWidget(const AppSearchField()));
      expect(find.byIcon(Icons.search), findsOneWidget);
    });
    ...
    testWidgets('should show clear button when text is present', (
      ...
      await tester.pumpWidget(
        createSimpleTestWidget(AppSearchField(controller: controller)),
      );
      await tester.pump();
  ...
  group('AppQuantityField', () {
    testWidgets('should display current value', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(AppQuantityField(value: 5, onChanged: (_) {})),
      );

...
Widget createL10nTestWidget(Widget Function(BuildContext context) builder) {
  return MaterialApp(
    ...
    home: Directionality(
      ...
      child: Scaffold(body: Builder(builder: (context) => builder(context))),
    ),
  );
}
...
void main() {
  group('AppEmptyState', () {
    testWidgets('should display title', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(
          const AppEmptyState(icon: Icons.inbox, title: 'No Data'),
        ),
      );
    ...
    testWidgets('should display icon', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(
          const AppEmptyState(icon: Icons.inbox, title: 'Empty'),
        ),
      );
  ...
  group('AppEmptyState static methods', () {
    ...
    testWidgets('noProducts should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noProducts(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('noCustomers should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noCustomers(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('emptyCart should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.emptyCart(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('noInvoices should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noInvoices(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('noData should render with defaults', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noData(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('noOrders should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noOrders(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('noConnection should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noConnection(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('noReports should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noReports(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('noLowStock should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noLowStock(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('noDebts should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noDebts(context)),
      );
      await tester.pumpAndSettle();
      expect(
    ...
    testWidgets('noReturns should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noReturns(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('noOffers should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppEmptyState.noOffers(context)),
      );
      await tester.pumpAndSettle();
  ...
  group('AppErrorState', () {
    ...
    testWidgets('should display details when provided', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(
          const AppErrorState(message: 'Error', details: 'Some details'),
        ),
      );
    ...
    testWidgets('should show retry button when onRetry provided', (
      ...
      await tester.pumpWidget(
        createL10nTestWidget(
          (context) => AppErrorState(message: 'Error', onRetry: () {}),
        ),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('network factory should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppErrorState.network(context)),
      );
      await tester.pumpAndSettle();
      expect(find.byIcon(Icons.wifi_off), findsOneWidget);
    });
    ...
    testWidgets('server factory should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppErrorState.server(context)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('general factory should render', (tester) async {
      await tester.pumpWidget(
        createL10nTestWidget((context) => AppErrorState.general(context)),
      );
      await tester.pumpAndSettle();
  ...
  group('AppLoadingState', () {
    testWidgets('should display progress indicator', (tester) async {
      await tester.pumpWidget(createSimpleTestWidget(const AppLoadingState()));
      expect(find.byType(CircularProgressIndicator), findsOneWidget);
    });

    testWidgets('should display message when provided', (tester) async {
      await tester.pumpWidget(
        createSimpleTestWidget(const AppLoadingState(message: 'Loading...')),
      );

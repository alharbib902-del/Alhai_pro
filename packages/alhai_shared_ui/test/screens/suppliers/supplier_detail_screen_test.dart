/// Widget tests for SupplierDetailScreen
///
...
Widget _buildTestWidget({String? supplierId}) {
...
void main() {
  ...
  setUp(() {
    ...
    when(() => mockDb.purchasesDao).thenReturn(mockPurchasesDao);
  ...
  group('SupplierDetailScreen', () {
    testWidgets('renders without errors when no supplierId', (tester) async {
    ...
    testWidgets('shows not found when supplier is null', (tester) async {
      _setLargeViewport(tester);
      addTearDown(() => tester.view.resetPhysicalSize());

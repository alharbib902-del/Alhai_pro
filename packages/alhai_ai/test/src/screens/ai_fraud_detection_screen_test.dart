...
import 'package:alhai_ai/src/screens/ai/ai_fraud_detection_screen.dart';
...
void main() {
  ...
  group('AiFraudDetectionScreen', () {
    testWidgets('renders without error', (tester) async {
      _setLargeViewport(tester);
      await tester.pumpWidget(
        _buildTestableWidget(const AiFraudDetectionScreen()),
      );
      await tester.pump(const Duration(seconds: 3));

      expect(find.byType(AiFraudDetectionScreen), findsOneWidget);
    });
    ...
    testWidgets('shows content after loading', (tester) async {
      ...
      // Screen renders its content (may show data or error state)
      expect(find.byType(AiFraudDetectionScreen), findsOneWidget);
    });

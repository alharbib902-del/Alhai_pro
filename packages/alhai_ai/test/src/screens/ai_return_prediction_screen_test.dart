...
import 'package:alhai_ai/src/screens/ai/ai_return_prediction_screen.dart';
...
void main() {
  ...
  group('AiReturnPredictionScreen', () {
    testWidgets('renders without error', (tester) async {
      _setLargeViewport(tester);
      await tester.pumpWidget(
        _buildTestableWidget(const AiReturnPredictionScreen()),
      );
      await tester.pump(const Duration(seconds: 3));

      expect(find.byType(AiReturnPredictionScreen), findsOneWidget);
    });

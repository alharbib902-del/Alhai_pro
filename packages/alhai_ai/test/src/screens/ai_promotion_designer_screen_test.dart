...
import 'package:alhai_ai/src/screens/ai/ai_promotion_designer_screen.dart';
...
void main() {
  ...
  group('AiPromotionDesignerScreen', () {
    testWidgets('renders without error', (tester) async {
      _setLargeViewport(tester);
      await tester.pumpWidget(
        _buildTestableWidget(const AiPromotionDesignerScreen()),
      );
      await tester.pump(const Duration(seconds: 3));

      expect(find.byType(AiPromotionDesignerScreen), findsOneWidget);
    });

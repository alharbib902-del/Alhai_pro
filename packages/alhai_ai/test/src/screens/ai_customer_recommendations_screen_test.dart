...
import 'package:alhai_ai/src/screens/ai/ai_customer_recommendations_screen.dart';
...
void main() {
  ...
  group('AiCustomerRecommendationsScreen', () {
    ...
    testWidgets('shows filter chips for customer segments', (tester) async {
      ...
      // Should find at least the "All" filter chip

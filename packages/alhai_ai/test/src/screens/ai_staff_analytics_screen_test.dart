...
import 'package:alhai_ai/src/screens/ai/ai_staff_analytics_screen.dart';
...
void main() {
  ...
  group('AiStaffAnalyticsScreen', () {
    testWidgets('renders without error', (tester) async {
      _setLargeViewport(tester);
      await tester.pumpWidget(
        _buildTestableWidget(const AiStaffAnalyticsScreen()),
      );
      await tester.pump(const Duration(seconds: 3));

      expect(find.byType(AiStaffAnalyticsScreen), findsOneWidget);
    });

...
import 'package:alhai_ai/src/screens/ai/ai_smart_pricing_screen.dart';
...
void main() {
  ...
  group('AiSmartPricingScreen', () {
    testWidgets('renders without error', (tester) async {
      _setLargeViewport(tester);
      await tester.pumpWidget(
        _buildTestableWidget(const AiSmartPricingScreen()),
      );
      await tester.pump(const Duration(seconds: 3));

      expect(find.byType(AiSmartPricingScreen), findsOneWidget);
    });
    ...
    testWidgets('shows pricing content', (tester) async {
      _setLargeViewport(tester);
      await tester.pumpWidget(
        _buildTestableWidget(const AiSmartPricingScreen()),
      );
      ...
      // The screen should have scrollable content

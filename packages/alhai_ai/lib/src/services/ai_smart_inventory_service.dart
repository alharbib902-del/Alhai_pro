  ...
  Future<List<EoqResult>> calculateEoq(String storeId) async {
    ...
    return [
      const EoqResult(
        ...
        orderCost: 50.0,
        holdingCost: 3.5,
        totalAnnualCost: 840.0,
        category: 'أرز',
      ),
      const EoqResult(
        productId: 'P007',
        name: 'حليب طويل الأمد', // Long-life Milk
        eoq: 200,
        reorderPoint: 80,
        safetyStock: 25,
        annualDemand: 2400,
  ...
  Future<List<WastePrediction>> getWastePredictions(String storeId) async {
    ...
    return [
      WastePrediction(
        ...
        suggestedAction: WasteSuggestedAction.discount,
        estimatedLoss: 318.5,
      ),
      WastePrediction(
        productId: 'P003',
        ...
        suggestedAction: WasteSuggestedAction.donate,
        estimatedLoss: 262.5,
      ),
      WastePrediction(
        productId: 'P009',
      ...
      WastePrediction(
        ...
        suggestedAction: WasteSuggestedAction.transfer,
        estimatedLoss: 144.0,
      ),
      WastePrediction(
        productId: 'P007',
        ...
        suggestedAction: WasteSuggestedAction.none,
        estimatedLoss: 35.0,
      ),
    ];
  }
  ...
  Future<List<ReorderSuggestion>> getReorderSuggestions(String storeId) async {
    ...
    return const [
      ...
      ReorderSuggestion(
        ...
        estimatedCost: 1320.0,
        daysOfStock: 8,
      ),
      ReorderSuggestion(
        productId: 'P012',
        name: 'سكر أبيض', // White Sugar
        currentStock: 55,
        reorderPoint: 50,
        suggestedQty: 100,

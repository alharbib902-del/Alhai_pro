...
class AiBasketAnalysisService {
  ...
  Future<List<ProductAssociation>> getAssociations(String storeId) async {
    ...
    return [
      ...
      const ProductAssociation(
        productAId: 'P001',
        productAName: 'أرز بسمتي', // Basmati Rice
        productBId: 'P002',
        productBName: 'بهارات مشكلة', // Mixed Spices
        frequency: 234,
        confidence: 0.82,
        lift: 3.4,
      ),
      ...
      const ProductAssociation(
        productAId: 'P003',
        productAName: 'خبز عربي', // Arabic Bread
        productBId: 'P004',
        productBName: 'جبنة بيضاء', // White Cheese
        frequency: 198,
        confidence: 0.78,
        lift: 2.9,
      ),
      ...
      const ProductAssociation(
        productAId: 'P005',
        productAName: 'حفاضات بامبرز', // Pampers Diapers
        productBId: 'P006',
        productBName: 'مناديل مبللة', // Wet Wipes
        frequency: 167,
        confidence: 0.91,
        lift: 5.2,
      ),
      ...
      const ProductAssociation(
        productAId: 'P007',
        productAName: 'حليب طويل الأمد', // Long-life Milk
        productBId: 'P008',
        productBName: 'كورن فليكس', // Corn Flakes
        frequency: 145,
        confidence: 0.72,
        lift: 2.6,
      ),
      ...
      const ProductAssociation(
        productAId: 'P009',
        productAName: 'دجاج طازج', // Fresh Chicken
        productBId: 'P010',
        productBName: 'صلصة طماطم', // Tomato Sauce
        frequency: 134,
        confidence: 0.68,
        lift: 2.3,
      ),
      ...
      const ProductAssociation(
        productAId: 'P011',
        productAName: 'شاي ربيع', // Rabea Tea
        productBId: 'P012',
        productBName: 'سكر أبيض', // White Sugar
        frequency: 189,
        confidence: 0.85,
        lift: 3.8,
      ),
      ...
      const ProductAssociation(
        productAId: 'P013',
        productAName: 'معكرونة سباغيتي', // Spaghetti
        productBId: 'P014',
        productBName: 'صلصة بستو', // Pesto Sauce
        frequency: 112,
        confidence: 0.65,
        lift: 2.1,
      ),
      ...
      const ProductAssociation(
        productAId: 'P015',
        productAName: 'ماء نوفا', // Nova Water
        productBId: 'P016',
        productBName: 'عصير المراعي', // Almarai Juice
        frequency: 223,
        confidence: 0.55,
        lift: 1.8,
      ),
      ...
      const ProductAssociation(
        productAId: 'P017',
        productAName: 'زيت عافية', // Afia Oil
        productBId: 'P001',
        productBName: 'أرز بسمتي', // Basmati Rice
        frequency: 156,
        confidence: 0.71,
        lift: 2.5,
      ),
      ...
      const ProductAssociation(
        productAId: 'P018',
        productAName: 'لبن المراعي', // Almarai Yogurt
        productBId: 'P019',
        productBName: 'تمر سكري', // Sukkari Dates
        frequency: 98,
        confidence: 0.62,
        lift: 2.0,
      ),

...
class _StaffPerformanceCardState extends State<StaffPerformanceCard>
  ...
  String _rankBadge(AppLocalizations l10n) {
    switch (widget.rank) {
      case 1: return 'نجم المتجر';
      case 2: return l10n.outstanding;
      case 3: return 'جيد جداً';
      default: return l10n.good;
    }
  }
            ...
            children: [
              ...
              Row(
                children: [
                  _MetricItem(
                    label: l10n.sales,
                    value: '${(widget.staff.salesVolume / 1000).toStringAsFixed(1)}K',
                  ...
                  _MetricItem(
                    ...
                    isDark: isDark,
                    valueColor: widget.staff.voidRate > 3 ? AppColors.error : null,
                  ),
                ],
              ),
...
class _SparklinePainter extends CustomPainter {
  ...
  _SparklinePainter({required this.values, required this.color, required this.isDark});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final lastY = range > 0
        ? size.height - ((values.last - minV) / range * size.height * 0.8 + size.height * 0.1)
        : size.height / 2;

...
final aiBasketAnalysisServiceProvider = Provider<AiBasketAnalysisService>((
  ref,
) {
...
final basketAssociationsProvider = FutureProvider<List<ProductAssociation>>((
  ref,
) async {
...
final bundleSuggestionsProvider = FutureProvider<List<BundleSuggestion>>((
  ref,
) async {
  final service = ref.watch(aiBasketAnalysisServiceProvider);
...
final basketApiProvider = FutureProvider.autoDispose<Map<String, dynamic>>((
  ref,
) async {

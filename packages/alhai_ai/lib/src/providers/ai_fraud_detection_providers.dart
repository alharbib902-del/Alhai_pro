...
final fraudAlertsProvider = FutureProvider.autoDispose<List<FraudAlert>>((
  ref,
) async {
...
final behaviorScoresProvider = FutureProvider.autoDispose<List<BehaviorScore>>((
  ref,
) async {
  final service = ref.watch(aiFraudDetectionServiceProvider);
...
final fraudSummaryProvider = FutureProvider.autoDispose<FraudDetectionSummary>((
  ref,
) async {
  final service = ref.watch(aiFraudDetectionServiceProvider);
...
final fraudSeverityFilterProvider = StateProvider<FraudSeverity?>(
  (ref) => null,
);
...
final filteredFraudAlertsProvider =
    Provider.autoDispose<AsyncValue<List<FraudAlert>>>((ref) {
...
final fraudInvestigationProvider = FutureProvider.autoDispose
    .family<Investigation, String>((ref, alertId) async {
      final service = ref.watch(aiFraudDetectionServiceProvider);
...
final fraudApiProvider = FutureProvider.autoDispose<Map<String, dynamic>>((
  ref,
) async {

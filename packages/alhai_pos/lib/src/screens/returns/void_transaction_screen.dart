...
class _VoidTransactionScreenState extends ConsumerState<VoidTransactionScreen> {
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    height: isMediumScreen ? AlhaiSpacing.xl : AlhaiSpacing.md,
                  ),
  ...
  Widget _buildSearchSection(
    ...
    return Container(
      padding: EdgeInsets.all(
        isMediumScreen ? AlhaiSpacing.xl : AlhaiSpacing.mdl,
      ),
      decoration: BoxDecoration(
        color: colorScheme.surface,
  ...
  Widget _buildItemsList(bool isDark, AppLocalizations l10n) {
    ...
    final remainingTotal = inv.items
        .skip(2)

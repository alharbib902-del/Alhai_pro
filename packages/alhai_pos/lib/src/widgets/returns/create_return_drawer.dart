...
class CreateReturnDrawer extends ConsumerStatefulWidget {
  ...
  const CreateReturnDrawer({super.key, this.onSuccess, this.scrollController});
...
class _CreateReturnDrawerState extends ConsumerState<CreateReturnDrawer> {
  ...
  Widget _buildStep2Items(
    ...
    return Column(
      ...
      children: [
        ...
        ...List.generate(
          _items.length,
          (i) => _buildItemCard(i, l10n, isDark, colorScheme),
        ),
      ],
    );
  }
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    const Spacer(),
                    Text(
                      l10n.availableToReturn(item.maxReturn),
                      style: TextStyle(
                        fontSize: 11,
                        color: colorScheme.onSurfaceVariant,
                      ),
  ...
  Widget _buildRefundMethodButton(
    String method,
    IconData icon,
    String label,
    bool isDark,
          ...
          Expanded(
            child: FilledButton.icon(
              onPressed: _currentStep == 3
                  ...
                  : _nextStep,
              icon: Icon(
                _currentStep == 3 ? Icons.check : Icons.arrow_back,
                size: 18,
              ),
              label: Text(

...
class _Denomination {
  ...
  String label(AppLocalizations l10n) {
    if (value >= 1) {
      return l10n.denominationRiyal(value.toStringAsFixed(0));
    } else {
      return l10n.denominationHalala((value * 100).toStringAsFixed(0));
    }
  }
}
    ...
    return Column(
      children: [
        ...
        TextButton.icon(
          ...
          style: TextButton.styleFrom(foregroundColor: AlhaiColors.error),
        ),
      ],
    );
  }

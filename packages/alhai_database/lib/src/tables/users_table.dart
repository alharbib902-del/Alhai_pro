...
@TableIndex(name: 'idx_users_store_role', columns: {#storeId, #role})
@TableIndex(name: 'idx_users_store_active', columns: {#storeId, #isActive})
@TableIndex(name: 'idx_users_org_id', columns: {#orgId})

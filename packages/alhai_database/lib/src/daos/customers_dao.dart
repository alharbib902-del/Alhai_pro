...
class CustomersDao extends DatabaseAccessor<AppDatabase>
  ...
  Future<List<CustomersTableData>> getCustomersPaginated(
    ...
    return (select(customersTable)
          ..where((c) {
            ...
            if (activeOnly) {
              condition =
                  condition & c.isActive.equals(true) & c.deletedAt.isNull();
            }
            return condition;
          })
          ..orderBy([(c) => OrderingTerm.asc(c.name)])
  ...
  Future<CustomersTableData?> getCustomerByPhone(String phone, String storeId) {
    return (select(customersTable)
          ..where((c) => c.storeId.equals(storeId) & c.phone.equals(phone)))
        .getSingleOrNull();
  }
  ...
  Future<int> insertAddress(CustomerAddressesTableCompanion address) =>
      into(customerAddressesTable).insert(address);
  Future<int> deleteAddress(String id) =>
      (delete(customerAddressesTable)..where((a) => a.id.equals(id))).go();

...
class OtpSendResult {
  ...
  factory OtpSendResult.error(String message) =>
      OtpSendResult._(isSuccess: false, error: message);
...
class OtpVerifyResult {
  ...
  factory OtpVerifyResult.error(String message) =>
      OtpVerifyResult._(isSuccess: false, error: message);
}

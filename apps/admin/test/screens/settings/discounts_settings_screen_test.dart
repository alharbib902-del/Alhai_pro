...
import 'package:admin/screens/settings/business/discounts_settings_screen.dart';
...
void main() {
  ...
  group('DiscountsSettingsScreen', () {
    ...
    testWidgets('shows discount icon', (tester) async {
      tester.view.physicalSize = const Size(1920, 1080);
      tester.view.devicePixelRatio = 1.0;
      suppressOverflowErrors();

...
Future<void> addCoupon(
  ...
  await db.discountsDao.insertCoupon(
    CouponsTableCompanion(
      ...
      value: Value((value * 100).round()),
      maxUses: Value(maxUses),
      currentUses: const Value(0),
      minPurchase: Value((minPurchase * 100).round()),
      isActive: const Value(true),
  ...
  try {
    ...
    await syncService.enqueueCreate(
      ...
      data: {
        ...
        'type': type,
        // C-4 Session 4: remote coupons.value, min_purchase are int cents.
        'value': (value * 100).round(),
        'max_uses': maxUses,
        'current_uses': 0,
        'min_purchase': (minPurchase * 100).round(),
        'is_active': true,

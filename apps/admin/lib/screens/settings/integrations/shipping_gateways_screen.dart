...
class _ShippingGatewaysScreenState
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(AppLocalizations.of(context).shippingGatewaysTitle,
                      style: TextStyle(
                          fontSize: 22,
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text(AppLocalizations.of(context).availableShippingGateways,
                      style: TextStyle(
                          fontSize: 16,
                  ...
                  Text(AppLocalizations.of(context).activateShippingGateways,
                      style: TextStyle(
                          fontSize: 13,
                          color:
                              Theme.of(context).colorScheme.onSurfaceVariant)),
  ...
  Widget _buildGatewayCard(String name, String nameEn, String description,
      IconData icon, bool isActive, Color brandColor, bool isDark,
            ...
            children: [
              ...
              if (isActive)
                TextButton(
                        ...
                        content: Column(
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                labelText:
                                    AppLocalizations.of(ctx).accountNumber,
                                hintText:
                                    AppLocalizations.of(ctx).accountNumber,
                              ),
                            ),
                  ...
                  child: Text(AppLocalizations.of(context).settingsAction,

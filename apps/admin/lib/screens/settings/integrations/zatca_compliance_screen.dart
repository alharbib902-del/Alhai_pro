...
class _ZatcaComplianceScreenState extends ConsumerState<ZatcaComplianceScreen> {
  ...
  Future<void> _loadSettings() async {
    try {
      ...
      final storeSettings = await getSettingsByPrefix(db, storeId, 'store_');
      ...
      if (mounted) {
        setState(() {
          ...
          _taxNumber =
              settings['zatca_tax_number'] ??
              storeSettings['store_tax_number'] ??
              '';
          _branchCode =
              settings['zatca_branch_code'] ??
      ...
      children: [
        ...
        _buildGroup(l10n.registrationInfo, [
          _tile(
            Icons.badge_rounded,
            l10n.taxNumber,
            _taxNumber.isNotEmpty ? _taxNumber : '—',
            isDark,
          ),
          _tile(
            Icons.business_rounded,
            l10n.businessName,
            l10n.businessNameValue,
            isDark,
          ),
          _tile(
            Icons.location_on_rounded,
            l10n.branchCode,
            _branchCode.isNotEmpty ? _branchCode : '—',
            isDark,
          ),
        ], isDark),
        ...
        _buildGroup(l10n.eInvoicing, [
          SwitchListTile(
            ...
            subtitle: Text(
              _eInvoicingEnabled ? l10n.enabled : l10n.disabled,
              style: TextStyle(

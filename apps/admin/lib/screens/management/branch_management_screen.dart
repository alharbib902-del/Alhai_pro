...
class _BranchManagementScreenState
  ...
  Future<void> _toggleStoreActive(StoresTableData store, bool isActive) async {
    try {
      final db = GetIt.I<AppDatabase>();
      final updated =
          store.copyWith(isActive: isActive, updatedAt: Value(DateTime.now()));
              ...
              if (nameController.text.isNotEmpty) {
                try {
                  ...
                  await db.storesDao.insertStore(StoresTableCompanion(
                    ...
                    address: Value(addressController.text.isEmpty
                        ? null
                        : addressController.text),
                    phone: Value(phoneController.text.isEmpty
                        ? null
                ...
                Expanded(
                  child: Column(
                      ...
                      children: [
                        ...
                        Text(store.isActive ? l10n.active : l10n.close,
                            style: TextStyle(
                                color: store.isActive
                                    ? AppColors.success
                                    : AppColors.textSecondary)),

...
class _DriverManagementScreenState
  ...
  Widget _buildContent(bool isWideScreen, bool isMediumScreen, bool isDark,
    ...
    final activeCount = _drivers
        .where((d) => d.status == 'active' || d.status == 'available')
        .length;
    final deliveringCount =
        _drivers.where((d) => d.status == 'out_for_delivery').length;
      ...
      children: [
        ...
        if (_drivers.isEmpty)
          AppEmptyState.noData(context,
              title: l10n.noDriversRegistered,
              description: l10n.addDriversForDelivery)
        else
                    ...
                    children: [
                              ...
                              Text(driver.rating.toStringAsFixed(1),
                                  style: TextStyle(
                                      ...
                                      color: Theme.of(context)
                                          ...
                                          .onSurfaceVariant)),
                              const SizedBox(width: AlhaiSpacing.xs),
                              Text(l10n.deliveriesToday(driver.todayDeliveries),
                                  style: TextStyle(
                                      fontSize: 12,
                                      color: Theme.of(context)
                                          .colorScheme
                      ...
                      Column(children: [
                        Container(
                          ...
                          child: Text(_getStatusName(driver.status, l10n),
                              style: TextStyle(
                                  fontSize: 11,
                                  color: _getStatusColor(driver.status),
            ...
            child: Center(
              child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: AlhaiSpacing.md),
                    Text(l10n.driversTrackingMap,
                        style: TextStyle(
                            color: Theme.of(context).colorScheme.onSurface)),
                    Text(l10n.gpsSubscriptionRequired,
                        style: TextStyle(
                            color: Theme.of(context)
                                .colorScheme
                                .onSurfaceVariant)),
        ...
        content: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            TextField(
                ...
                decoration: InputDecoration(
                    labelText: l10n.plateNumberLabel,
          ...
          child: ListView(
            ...
            children: [
              ...
              _DetailTile(
                  ...
                  value: driver.vehicle.isNotEmpty ? driver.vehicle : '\u2014',
                  isDark: isDark),
              _DetailTile(
                  icon: Icons.confirmation_number,
                  label: l10n.plateNumberLabel,
                  value: driver.plateNumber.isNotEmpty
                      ? driver.plateNumber
                      : '\u2014',
                  isDark: isDark),
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          ListTile(
              ...
              title: Text('${l10n.orderLabel} #2024-003'),
              subtitle: const Text('Sample Customer 1'),
              trailing: const Icon(Icons.radio_button_checked,
                  color: AppColors.info)),
          ListTile(
              leading: const Icon(Icons.receipt_long),
              title: Text('${l10n.orderLabel} #2024-008'),
              subtitle: const Text('Sample Customer 2'),

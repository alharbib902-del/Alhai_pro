...
class _PurchaseFormScreenState extends ConsumerState<PurchaseFormScreen> {
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  title: Text(item.productName, style: TextStyle(fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.onSurface)),
                  subtitle: Text(
        ...
        children: [
          ...
          SegmentedButton<String>(
            segments: [
              ...
              ButtonSegment(value: 'credit', label: Text(l10n.deferredPayment), icon: const Icon(Icons.schedule)),
            ],
  ...
  Widget _buildTotalCard(bool isDark) {
    ...
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(l10n.totalLabel, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.onSurface)),
          Text(
            '${_subtotal.toStringAsFixed(2)} \u0631.\u0633',
            style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: isDark ? AppColors.primaryLight : AppColors.primaryDark),
          ),
        ],
      ),
    );
  ...
  Future<void> _savePurchase() async {
    ...
    try {
      ...
      final selectedSupplier = suppliers.firstWhere((s) => s.id == _selectedSupplierId, orElse: () => suppliers.first);
      ...
      final purchaseId = await createPurchase(
        ...
        discount: 0,
        total: _subtotal,
        notes: _invoiceNoController.text.isNotEmpty ? '\u0631\u0642\u0645 \u0641\u0627\u062A\u0648\u0631\u0629 \u0627\u0644\u0645\u0648\u0631\u062F: ${_invoiceNoController.text}' : null,
        items: purchaseItems,
      );
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(l10n.purchaseInvoiceSaved(_subtotal.toStringAsFixed(2))), backgroundColor: AppColors.success),
        );
        context.pop();
      }
    } catch (e) {
      if (mounted) {
        setState(() => _isSaving = false);
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(l10n.errorSavingPurchase(e)), backgroundColor: AppColors.error),
        );
      }
    }
  }

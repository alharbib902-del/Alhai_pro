...
class SmartPromotionsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SmartPromotionsScreen> createState() =>
      _SmartPromotionsScreenState();
}
...
class _SmartPromotionsScreenState extends ConsumerState<SmartPromotionsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading =
        activePromotionsAsync.isLoading || lowStockAsync.isLoading;
  ...
  void _applyPromotionForProduct(
    ...
    try {
      await addPromotion(
        ...
        type: 'flash_sale',
        description:
            'Auto-generated promotion for slow-moving product: ${product.name}',
      );
      if (!mounted) return;
  ...
  String _getTypeName(String type, AppLocalizations l10n) {
    switch (type) {
      case 'percentage':
        return l10n.percentageType;
      case 'buy_x_get_y':
        return l10n.buyXGetYType;
      case 'buyXgetY':
        return l10n.buyXGetYType;
      case 'fixed':
        return l10n.fixedAmountType;
      case 'bundle':
        return l10n.buyXGetYType;
      case 'flash_sale':
        return l10n.percentageType;

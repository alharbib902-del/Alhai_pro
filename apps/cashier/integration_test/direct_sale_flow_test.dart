...
void main() {
  ...
  group('Flow 1: Direct Sale - دورة بيع مباشر', () {
    ...
    group('Step 1: Cashier Login', () {
      ...
      testWidgets(
        'successful OTP verification reaches store select or POS',
        (tester) async {
      ...
      testWidgets(
        'store selection navigates to POS screen',
        (tester) async {
    ...
    group('Step 2: Open Register / Shift', () {
      ...
      testWidgets(
        'entering opening cash and confirming opens the shift',
        (tester) async {
    ...
    group('Step 3: Add Products to Cart', () {
      ...
      testWidgets(
        'search field is present for product lookup / barcode entry',
        (tester) async {
          // Arrange
          await tester.pumpWidget(buildTestApp(
            initialRoute: '/pos',
      ...
      testWidgets(
        'barcode entry adds product to cart via barcode listener',
        (tester) async {
    ...
    group('Step 4: Modify Quantity in Cart', () {
      testWidgets(
        'cart with items shows quantity controls',
        (tester) async {
      ...
      testWidgets(
        'tapping increment button increases quantity',
        (tester) async {
      ...
      testWidgets(
        'tapping decrement button decreases quantity',
        (tester) async {
    ...
    group('Step 5: Payment Method Selection', () {
      ...
      testWidgets(
        'cash payment method is selected by default',
        (tester) async {
      ...
      testWidgets(
        'card payment method can be selected',
        (tester) async {
          // Arrange
          await tester.pumpWidget(buildTestApp(
            initialRoute: '/pos/payment',
    ...
    group('Step 6: Complete Payment', () {
      testWidgets(
        'entering cash amount enables payment button',
        (tester) async {
          // Arrange
          await tester.pumpWidget(buildTestApp(
            initialRoute: '/pos/payment',
      ...
      testWidgets(
        'tapping pay button processes the sale',
        (tester) async {
          // Arrange
          await tester.pumpWidget(buildTestApp(
            initialRoute: '/pos/payment',
    ...
    group('Step 7: ZATCA Invoice', () {
      testWidgets(
        'receipt screen displays after successful sale',
        (tester) async {
      ...
      testWidgets(
        'receipt screen contains QR code for ZATCA compliance',
        (tester) async {
    ...
    group('Step 8: Print Receipt', () {
      testWidgets(
        'receipt screen has print action button',
        (tester) async {
          // Arrange
          await tester.pumpWidget(buildTestApp(
            initialRoute: '/pos/receipt',
    ...
    group('Step 9: Inventory Update', () {
      testWidgets(
        'inventory screen is accessible after sale',
        (tester) async {
    ...
    group('Step 10: Admin Reports', () {
      testWidgets(
        'sales history screen is accessible',
        (tester) async {
      ...
      testWidgets(
        'dashboard shows sale statistics',
        (tester) async {
    ...
    group('End-to-End: Complete Sale Lifecycle', () {
      testWidgets(
        'full flow: POS -> add items -> payment -> receipt',
        (tester) async {

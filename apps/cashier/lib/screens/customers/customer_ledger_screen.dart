...
class _CustomerLedgerScreenState extends ConsumerState<CustomerLedgerScreen> {
  ...
  Widget _buildCustomerInfoCard(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: Theme.of(context).brightness == Brightness.dark ? null : AppSizes.shadowSm,
      ),
      child: Row(
        children: [
          Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                _buildFilterChip(l10n.allPeriods, _dateFilter == 'all',
                    () => setState(() { _dateFilter = 'all'; _customDateRange = null; }), colorScheme),
                const SizedBox(width: AlhaiSpacing.xs),
                _buildFilterChip(l10n.thisMonthPeriod, _dateFilter == 'thisMonth',
                    () => setState(() => _dateFilter = 'thisMonth'), colorScheme),
                const SizedBox(width: AlhaiSpacing.xs),
                _buildFilterChip(l10n.threeMonths, _dateFilter == 'threeMonths',
                    () => setState(() => _dateFilter = 'threeMonths'), colorScheme),
                const SizedBox(width: AlhaiSpacing.xs),
                _buildFilterChip(l10n.dateFromTo, _dateFilter == 'custom',
                    _selectDateRange, colorScheme, icon: Icons.date_range_outlined),
              ],
            ),
          ),
          const SizedBox(height: AlhaiSpacing.md),
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: AlhaiSpacing.xs),
                _buildFilterChip(l10n.adjustments, _typeFilter == 'adjustment',
                    () => setState(() => _typeFilter = 'adjustment'), colorScheme),
              ],
            ),
          ),
        ],
  ...
  Widget _buildFilterChip(
      String label, bool isSelected, VoidCallback onTap, ColorScheme colorScheme,
      {IconData? icon}) {
    return InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(999),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                _tableHeaderCell(l10n.statementCol, flex: 3, colorScheme: colorScheme),
                _tableHeaderCell(l10n.referenceCol, flex: 2, colorScheme: colorScheme),
  ...
  Widget _tableHeaderCell(String text,
      {required int flex, required ColorScheme colorScheme, TextAlign align = TextAlign.start}) {
    return Expanded(
      flex: flex,
      child: Text(text,
          textAlign: align,
  ...
  Widget _buildTableRow(
      Map<String, dynamic> txn, int index, ColorScheme colorScheme, AppLocalizations l10n) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: type == 'adjustment'
            ? AppColors.warning.withValues(alpha: Theme.of(context).brightness == Brightness.dark ? 0.08 : 0.05)
            : (index.isEven ? Colors.transparent : colorScheme.surfaceContainerHighest.withValues(alpha: 0.5)),
        border: Border(
      ...
      child: Row(
        children: [
            ...
            child: Row(
              children: [
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Icon(_getTypeIcon(type), size: 15, color: _getTypeColor(type)),
                ),
          ...
          Expanded(flex: 2, child: Text(txn['reference'] as String,
          ...
          Expanded(flex: 2, child: Text(balance.toStringAsFixed(2),
              textAlign: TextAlign.end,
  ...
  Widget _buildMobileTransactions(ColorScheme colorScheme, AppLocalizations l10n) {
    final txns = _filteredTransactions;
    if (txns.isEmpty) return _buildEmptyState(colorScheme, l10n);

    return Column(
      children: txns.map((txn) => Padding(
  ...
  Widget _buildMobileTransactionCard(
      Map<String, dynamic> txn, ColorScheme colorScheme, AppLocalizations l10n) {
    final type = txn['type'] as String;
    final date = txn['date'] as DateTime;
    final debit = txn['debit'] as double;
    final credit = txn['credit'] as double;
    ...
    return Container(
      ...
      child: IntrinsicHeight(
        child: Row(
          children: [
            if (type == 'adjustment') Container(width: 4, color: AppColors.warning),
            Expanded(
              child: Padding(
                padding: EdgeInsetsDirectional.only(
                    start: type == 'adjustment' ? 12 : 16, end: 16, top: 14, bottom: 14),
                child: Row(
                  children: [
                    Container(
                      width: 32, height: 32,
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700,
                              color: isDebitTx ? AppColors.error : AppColors.success),
                        ),
  ...
  Widget _buildSummaryBar(ColorScheme colorScheme, AppLocalizations l10n) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(child: _buildSummaryItem(l10n.totalDebit,
              _totalDebit.toStringAsFixed(2), AppColors.error, Icons.arrow_upward_rounded, colorScheme)),
          Container(width: 1, height: 48, color: colorScheme.outlineVariant,
              margin: const EdgeInsets.symmetric(horizontal: AlhaiSpacing.md)),
          Expanded(child: _buildSummaryItem(l10n.totalCredit,
              _totalCredit.toStringAsFixed(2), AppColors.success, Icons.arrow_downward_rounded, colorScheme)),
          Container(width: 1, height: 48, color: colorScheme.outlineVariant,
              margin: const EdgeInsets.symmetric(horizontal: AlhaiSpacing.md)),
          Expanded(child: _buildSummaryItem(l10n.finalBalance,
              finalBalance.abs().toStringAsFixed(2),
              finalBalance > 0 ? AppColors.error : AppColors.success,
              Icons.account_balance_wallet_outlined, colorScheme, isBold: true)),
        ],
      ),
    );
  }
  ...
  Widget _buildSummaryItem(String label, String value, Color color,
      IconData icon, ColorScheme colorScheme, {bool isBold = false}) {
    return Column(
  ...
  Widget _buildMobileBottomSummary(ColorScheme colorScheme, AppLocalizations l10n) {
    final finalBalance = _totalDebit - _totalCredit;
          ...
          children: [
            Expanded(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Text(l10n.totalDebit, style: TextStyle(fontSize: 10,
                    fontWeight: FontWeight.w500, color: colorScheme.outline)),
                const SizedBox(height: AlhaiSpacing.xxxs),
            ...
            Expanded(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                Text(l10n.totalCredit, style: TextStyle(fontSize: 10,
                    fontWeight: FontWeight.w500, color: colorScheme.outline)),
                const SizedBox(height: AlhaiSpacing.xxxs),
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: (finalBalance > 0 ? AppColors.error : AppColors.success).withValues(alpha: 0.1),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Text(l10n.finalBalance, style: TextStyle(fontSize: 10,
                      fontWeight: FontWeight.w500, color: colorScheme.outline)),
                  const SizedBox(height: AlhaiSpacing.xxxs),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Container(
                        ...
                        alignment: Alignment.center,
                        child: const Icon(Icons.tune_rounded, size: 20, color: AppColors.warning),
                      ),
                      const SizedBox(width: AlhaiSpacing.sm),
                      Text(l10n.manualAdjustment, style: TextStyle(fontSize: 18,
                          fontWeight: FontWeight.w700, color: dialogColorScheme.onSurface)),
                      const Spacer(),
                      IconButton(
                  ...
                  const SizedBox(height: AlhaiSpacing.lg),
                  Text(l10n.adjustmentType, style: TextStyle(fontSize: 13,
                      fontWeight: FontWeight.w600, color: dialogColorScheme.onSurfaceVariant)),
                  const SizedBox(height: AlhaiSpacing.xs),
                  Row(
                    children: [
                      Expanded(child: _buildTypeOption(l10n.debitAdjustment,
                          Icons.arrow_upward_rounded, AppColors.error,
                          adjustmentType == 'debit',
                          () => setDialogState(() => adjustmentType = 'debit'), dialogColorScheme)),
                      const SizedBox(width: AlhaiSpacing.sm),
                      Expanded(child: _buildTypeOption(l10n.creditAdjustment,
                          Icons.arrow_downward_rounded, AppColors.success,
                          adjustmentType == 'credit',
                          () => setDialogState(() => adjustmentType = 'credit'), dialogColorScheme)),
                    ],
                  ),
                  const SizedBox(height: AlhaiSpacing.mdl),
                  Text(l10n.adjustmentAmount, style: TextStyle(fontSize: 13,
                      fontWeight: FontWeight.w600, color: dialogColorScheme.onSurfaceVariant)),
                  const SizedBox(height: AlhaiSpacing.xs),
                  TextField(
                  ...
                  const SizedBox(height: AlhaiSpacing.mdl),
                  Text(l10n.adjustmentReason, style: TextStyle(fontSize: 13,
                      fontWeight: FontWeight.w600, color: dialogColorScheme.onSurfaceVariant)),
                  const SizedBox(height: AlhaiSpacing.xs),
                  TextField(
                      ...
                      Expanded(
                        child: OutlinedButton(
                          ...
                          style: OutlinedButton.styleFrom(
                            ...
                            side: BorderSide(color: dialogColorScheme.outlineVariant),
                        ...
                        child: FilledButton.icon(
                          onPressed: () {
                            ...
                            _handleSaveAdjustment(
                                adjustmentType, amount, reasonController.text, DateTime.now(), l10n);
                          },
  ...
  Widget _buildTypeOption(String label, IconData icon, Color color,
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        padding: const EdgeInsets.symmetric(vertical: 14),
        decoration: BoxDecoration(
          color: isSelected ? color.withValues(alpha: 0.1) : colorScheme.surfaceContainerHighest,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(icon, size: 18, color: isSelected ? color : colorScheme.onSurfaceVariant),
            const SizedBox(width: AlhaiSpacing.xs),
  ...
  Future<void> _selectDateRange() async {
    ...
    if (picked != null) {
      setState(() { _dateFilter = 'custom'; _customDateRange = picked; });
    }
  }

  IconData _getTypeIcon(String type) {
    switch (type) {
      case 'opening': return Icons.account_balance_outlined;
      ...
      case 'return': return Icons.assignment_return_outlined;
  ...
  String _getTypeLabel(String type, AppLocalizations l10n) {
    switch (type) {
      case 'opening': return l10n.openingBalance;
      case 'invoice': return l10n.invoices;
      case 'payment': return l10n.payment;
      case 'adjustment': return l10n.adjustmentEntry;
      case 'return': return l10n.returnEntry;
      default: return type;
    }
  }

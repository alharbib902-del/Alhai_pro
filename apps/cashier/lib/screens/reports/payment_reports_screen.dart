      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            if (icon != null) ...[
              Icon(icon, size: 14,
                  color: isSelected ? AppColors.textOnPrimary : AppColors.getTextSecondary(isDark)),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              const SizedBox(width: AlhaiSpacing.lg),
              _buildLegendItem(l10n.card, AppColors.info, isDark),
              const SizedBox(width: AlhaiSpacing.lg),
              _buildLegendItem(l10n.credit, AppColors.secondary, isDark),
            ],
          ),
        ],
      ),

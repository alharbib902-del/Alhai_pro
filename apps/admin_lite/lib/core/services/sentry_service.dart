...
///
/// Usage:
/// flutter run --dart-define=SENTRY_DSN_ADMIN_LITE=https://xxx@xxx.ingest.sentry.io/xxx
/// flutter build apk --dart-define=SENTRY_DSN_ADMIN_LITE=https://xxx@xxx.ingest.sentry.io/xxx
const _sentryDsn = String.fromEnvironment('SENTRY_DSN_ADMIN_LITE');

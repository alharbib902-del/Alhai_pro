...
class LitePendingApprovalsScreen extends ConsumerWidget {
  ...
  Future<void> _handleAction(BuildContext context, WidgetRef ref,
    ...
    if (item.type == 'refund') {
      ...
      await db.auditLogDao.log(
        ...
        entityId: item.id,
        description:
            '${newStatus == 'approved' ? 'Approved' : 'Rejected'} purchase: ${item.id}',
      );
    }
  ...
  IconData _typeIcon(String type) =>
      type == 'refund' ? Icons.undo : Icons.shopping_cart;
  Color _typeColor(String type) =>
      type == 'refund' ? AlhaiColors.warning : AlhaiColors.info;
            ...
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: () =>
                      _handleAction(context, ref, item, 'rejected', l10n),
              ...
              Expanded(
                child: FilledButton.icon(
                  onPressed: () =>
                      _handleAction(context, ref, item, 'approved', l10n),

...
void main() {
  group('Admin Lite DI - GetIt instance', () {
    test('getIt is the same instance as core.getIt', () {
      // The admin_lite app uses the same GetIt instance as alhai_core
  ...
  group('Admin Lite DI - AppRoutes availability', () {
    test('AppRoutes.dashboard is defined', () {
      expect('/dashboard', isNotEmpty);
    });

    test('AppRoutes.reports is defined', () {
  ...
  group('Admin Lite DI - GetIt utilities', () {
